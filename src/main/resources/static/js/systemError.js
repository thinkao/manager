...
var TableInit = function () {
    ...
    oTableInit.Init = function () {
        $('#systemError').bootstrapTable({
            url: '/reportController/errorQuery',   //请求后台的URL（*）
            method: 'post',                      //请求方式（*）
...
var ButtonInit = function () {
    ...
    oInit.Init = function () {
        $("#btn_errorQuery").click(function () {
            ...
            $("#systemError").bootstrapTable('refreshOptions', {pageNumber: 1, pageSize: 10});
        });
    };
    return oInit;
};
