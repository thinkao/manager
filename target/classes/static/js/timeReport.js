...
var TableInit = function () {
    ...
    oTableInit.Init = function () {
        $('#timeReport').bootstrapTable({
            url: '/reportController/timeQuery',   //请求后台的URL（*）
            method: 'post',                      //请求方式（*）
...
var ButtonInit = function () {
    ...
    oInit.Init = function () {
        $("#btn_timeQuery").click(function () {
            ...
            $("#timeReport").bootstrapTable('refreshOptions', {pageNumber: 1, pageSize: 10});
        });
    };
    return oInit;
};
